...
//            throw new CommonException(ErrorCategories.BUSINESS_ROLE_ERROR,
...
//        userInfo.put(Constant.NUMBER_FORMATTER_MAP_KEY,JwtTokenHelper.getUserNumberFormatter(token));
//        return userInfo;
//    }
