package com.project.multimodule.error.advice;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.annotation.JsonRootName;
import com.project.multimodule.error.exception.CommonException;
import com.project.multimodule.error.exception.NotAllowedException;
import com.project.multimodule.error.exception.NotFoundException;
import com.project.multimodule.error.exception.RefreshTokenException;
import com.project.multimodule.util.WebUtils;
...
//        }
    ...
    /**
     * handle {@link CommonException} exception.
     *
     * @param ex exception instance
     * @return obie API response represent the given exception
     */
    @ExceptionHandler(CommonException.class)
    public ResponseEntity<ApiCallError<String>> handleEnergiTechException(HttpServletRequest request, CommonException ex) {
        ...
        return ResponseEntity
                ...
                .body(new ApiCallError<>(
                        !isNull(ex.getBusinessErrorCode())
